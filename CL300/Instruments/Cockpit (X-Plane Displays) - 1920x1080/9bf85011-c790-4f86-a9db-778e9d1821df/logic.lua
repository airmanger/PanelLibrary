...
local MAIN  = Page.new("MAIN", "BG_GREY",   nil, nil)
...
addKeyM( 48, 28, XCmd("cl300/mfd_frmt"))
addKeyM( 48, 76, XCmd("cl300/mfd_aice"))
addKeyM( 96, 28, XCmd("cl300/mfd_tfc"))
addKeyM( 96, 76, XCmd("cl300/mfd_ecs"))
addKeyM(144, 28, XCmd("cl300/mfd_trwx"))
addKeyM(144, 76, XCmd("cl300/mfd_elec"))
addKeyM(192, 76, XCmd("cl300/mfd_flt"))
addKeyM(216, 28, XCmd("cl300/mfd_cas"))
addKeyM(240, 76, XCmd("cl300/mfd_fuel"))
addKeyM(288, 28, XCmd("cl300/mfd_sumry"))
addKeyM(288, 76, XCmd("cl300/mfd_hyd"))
addKeyM(336, 76, XCmd("cl300/mfd_cklst"))
addKeyM(360, 28, XCmd("cl300/chklist_enter"))
addKeyM(384, 76, XCmd("cl300/chklist_skip"))
addKeyM(429, 52, XCmd("cl300/chklist_jleft"))
addKeyM(468, 52, XCmd("cl300/chklist_jright"))

PANEL = PD:createInstance(MAIN, "CLK", 564, 976)
